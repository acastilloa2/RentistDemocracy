...
use "C:\Users\Alejandro Castillo\OneDrive - Universidad de los Andes\Documentos\GitHub\RentistDemocracy\Data\panel1.dta", clear
...
reg ws c.log_y##i.treatment censoe_total iica g_func_personal sgp_total

* Regresión con efectos fijos municipios

reghdfe ws c.log_y i.treatment censoe_total iica, a(codmpio)

reghdfe ws c.log_y i.treatment censoe_total iica, a(coddpto)

* Regresión con efectos fijos absorbidos

reghdfe ws c.log_y##i.treatment censoe_total iica, a(departamento)
...
reghdfe ws i.quintil_log_y i.treatment censoe_total iica, a(coddpto)
...
keep if inlist(departamento, "CASANARE", "META", "ARAUCA", "VICHADA", "LA GUAJIRA")

reghdfe ws c.y_cap_regalias_adj##i.treatment censoe_total iica g_func_persona, a(coddpto)
